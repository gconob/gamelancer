    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio1', models.ForeignKey(related_name='portfolio1', to='gamelancer_main.Portfolio')),
                ('portfolio2', models.ForeignKey(related_name='portfolio2', to='gamelancer_main.Portfolio')),
                ('portfolio3', models.ForeignKey(related_name='portfolio3', to='gamelancer_main.Portfolio')),
